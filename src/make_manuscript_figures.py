...
def build_figure1() -> None:
    ...
    ax2.text(
        4.5,
        0.20,
        "Primary contrast: adjusted difference in average 10-year memory change between baseline loneliness groups",
        ha="center",
        va="center",
        fontsize=6.5,
        color=MUTED,
...
def build_figure5() -> None:
    ...
    forest_panel(
        ...
        "display_label",
        ORANGE,
        "Difference in 10-year slope contrast (SD)",
        (-0.25, 0.25),
        panel="E",
        fontsize=5.95,
    )
