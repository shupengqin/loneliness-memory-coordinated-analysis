        ...
        rows.append(
            {
                ...
                "Participant-wave observations": n(model_n.loc[cohort, "observations"]),
    ...
    rows.append(
        {
            ...
            "Participant-wave observations": n(model_n["observations"].sum()),
        ...
        rows.append(
            {
                ...
                "Participant-wave observations": n(row["observations"]),
                "Estimate": three(row["estimate"]),
                "95% CI": f"{three(row['ci_low'])} to {three(row['ci_high'])}",
                "P value": p_value(row["p_value"]),
                "I-squared (%)": "-",
